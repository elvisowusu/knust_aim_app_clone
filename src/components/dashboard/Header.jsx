...
export const Header = () => {
  return (
    <header className="fixed flex flex-row justify-between items-center w-full md:pl-[6.8rem] lg:pl-[17.8rem] right-0 z-20 px-6 h-[4.4rem] bg-black overflow-hidden">
      <img
